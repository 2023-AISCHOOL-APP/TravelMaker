...
const Preference = () => {
  ...
  const surveys = [
    ...
    {
      question: '보고싶은건 다 넣었는데...괜찮을까?',
      options: ['그런 식으로 다 넣으면 여행 가서 뭐 볼지 고민하느라 시간 낭비야! 일단 현실적인 계획을 세우는게 중요해',
       '뭐 어때 계획을 세웠다는게 대단한거야! 자세한 건 여행 가서 생각하자~'],
    },
    {
      question: '여행은 사실 인생샷을 건지러 가는거 아니겠어?',
      options: ['너 뭘 좀 아는구나? 여행 가서 사진을 안찍을 거면 왜가냐고! 남는건 사진이야 인스타에 올려야지!', 
      '그런가? 나는 사진찍을 시간에 더 많은걸 보고싶은데...추억은 눈으로 찍어서 가슴에 담는거야!'],
    },
    {
    ...
    },
    {
      ...
      '밥은 뭘 먹든 상관없어 그리고 맛집에 가면 줄 서야 하잖아? 밥먹으려고 서서 기다린건 엄마 배 속에서 밖에 없어'],
    },
    {
      question: '돈이 너무 많이 들 거 같은데 괜찮을까?',
      options: ['야! 이럴 때 쓰는거지! 죽을 때 모아둔 돈 가지고 갈 거야? ', 
